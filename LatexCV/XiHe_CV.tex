...
\par{\centering{(484)633-8040 \quad xih314@lehigh.edu\quad \href{http://xihey.com}{http://xihey.com}}\par} \\% Your name
...
\begin{longtable}{>{\centering}p{3.35cm}|p{14cm}}
    ...
    % \small{Aug 15' - Present}&\textbf{Efficient Implementation on Training Deep Learning Network}\\ 
    % & \lst{Using C\texttt{++} to implement various of standard approaches to training deep learning model}\\
    % &\lst {Apply high performance computing techniques to accelerate training rate}\\


    \small{\textbf{Internship}}& \textit{Predictive Analytics and Monitoring, Siemens Corporation, Princeton, NJ, USA}\\\
...
\begin{longtable}{>{\centering}p{3.3cm}|p{14cm}}
    ...
    % &\lst{\textbf{\emph{Question $\mbox{\&}$ Answer System:}} By detect.}\\
    ...
    Spring 14'& \textbf{Machine Learning,} Andrew Ng, Coursera.\\
    In progress&\textbf{High Performance Scientific Computing,} Randall J. LeVeque, Coursera.
\end{longtable}

\section{Talks}
\begin{longtable}{>{\centering}p{3.3cm}|p{14cm}}
    On going &\textbf{Dual Free SDCA for Empirical Risk Minimization with Adaptive Probabilities,} NIPS 2015, Montréal, Canada.  \\
