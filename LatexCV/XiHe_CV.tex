...
\par{\centering{(484)633-8040 \quad xih314@lehigh.edu\quad \href{xihey.com/intro}{xihey.com}}\par} \\% Your name
...
\begin{longtable}{>{\centering}p{3.3cm}|p{14cm}}
    ...
    \pagebreak
    % &\textbf{[4] Coordinate Descent Methods for Linearly Constrained Optimization,} with Martin Takáč.\\
    Journal &\textbf{[4] A Method with Parameter for Solving the Spectral Radius of Nonnegative Tensor,} with Yiyong Li, Qingzhi Yang. Under Review.
\end{longtable}
...
\begin{longtable}{>{\centering}p{3.3cm}|p{14cm}}
   Sep 15' - May 16' & Dean’s Doctoral Fellowship, Lehigh University.\\
