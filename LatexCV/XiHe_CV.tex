...
\par{\centering{(484)633-8040 \quad xih314@lehigh.edu\quad \href{http://xihey.com/intro}{http://xihey.com}}\par} \\% Your name
...
\begin{longtable}{>{\centering}p{3.35cm}|p{14cm}}
    ...
    &\lst {Apply high performance computing technique to accelerate training rate}\\
